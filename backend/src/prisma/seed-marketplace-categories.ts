...
const SEED_DATA = [
  ...
  },
  {
    ...
    subcategories: [
      { key: "livestock", nameEn: "Livestock", nameSo: "Xoolaha" },
      { key: "pets", nameEn: "Pets", nameSo: "Xayawaanka" },
      { key: "feed", nameEn: "Feed", nameSo: "Quudinta" },
      { key: "accessories", nameEn: "Accessories", nameSo: "Agabka" },
      { key: "other", nameEn: "Other", nameSo: "Kale" },
    ],
  },
  {
