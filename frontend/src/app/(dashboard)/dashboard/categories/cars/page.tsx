...
export default function CarManagement() {
  ...
  const handleTogglePaid = async (car: Car) => {
    ...
    setItems((prev) =>
      prev.map((c) =>
        String(c.id) === carId ? { ...c, isPaid: newStatus } : c,
      ),
    );
                  ...
                  <table className="w-full table-fixed">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="border-b p-3 text-xs font-semibold text-left w-[20%]">
                          Title
                        </th>
