    ...
    <div className="py-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-3 max-w-2xl">
        ...
        <div className="grid grid-cols-2 gap-2">
          <input value={bedrooms} onChange={(e)=>setBedrooms(e.target.value)} placeholder="Bedrooms" className="p-2 border rounded" />
          <input value={bathrooms} onChange={(e)=>setBathrooms(e.target.value)} placeholder="Bathrooms" className="p-2 border rounded" />
        </div>
        <input value={squareFeet} onChange={(e)=>setSquareFeet(e.target.value)} placeholder="Square Feet" className="w-full p-2 border rounded" />
        <input value={address} onChange={(e)=>setAddress(e.target.value)} placeholder="Address" className="w-full p-2 border rounded" />
        <div className="flex gap-2 items-center">
          <label className="flex items-center gap-2"><input type="checkbox" checked={hasGarage} onChange={(e)=>setHasGarage(e.target.checked)} /> Has Garage</label>
          <label className="flex items-center gap-2"><input type="checkbox" checked={hasGarden} onChange={(e)=>setHasGarden(e.target.checked)} /> Has Garden</label>
        </div>
        ...
        <input value={county} onChange={(e)=>setCounty(e.target.value)} placeholder="County" className="w-full p-2 border rounded" />
