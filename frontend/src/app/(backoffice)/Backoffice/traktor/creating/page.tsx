  ...
  return (
    <div className="py-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-3 max-w-2xl">
        ...
        <input value={traktortModel} onChange={(e)=>setTraktortModel(e.target.value)} placeholder="Traktor Model" className="w-full p-2 border rounded" />
        <div className="grid grid-cols-3 gap-2"><input value={year} onChange={(e)=>setYear(e.target.value)} placeholder="Year" className="p-2 border rounded" /><input value={conditionVal} onChange={(e)=>setConditionVal(e.target.value)} placeholder="Condition" className="p-2 border rounded" /><input value={hours} onChange={(e)=>setHours(e.target.value)} placeholder="Hours" className="p-2 border rounded" /></div>
        <input value={enginePower} onChange={(e)=>setEnginePower(e.target.value)} placeholder="Engine Power" className="w-full p-2 border rounded" />
