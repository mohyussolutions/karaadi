...
export default function TractorsEdit() {
  const [title, setTitle] = useState("");
  const [power, setPower] = useState("");

  return (
    <div className="py-6">
      <h2 className="text-2xl font-bold mb-4">Edit Tractor (demo)</h2>
      <form className="space-y-4 max-w-xl" onSubmit={(e) => { e.preventDefault(); alert('Tractor updated (demo)'); }}>
        <div>
