...
/* ─── Sub-navbar / category listing pages ────────────────────────────────── */
  ...
  <div className="container mx-auto px-2 py-2 space-y-4 animate-pulse">
    ...
    <div className="flex gap-2 overflow-hidden">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="h-9 bg-gray-200 rounded-full w-20 flex-shrink-0" />
      ))}
    </div>
    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 animate-pulse">
      ...
      <div className="flex gap-2 mb-6 overflow-hidden">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="h-9 bg-gray-200 rounded-lg w-24 flex-shrink-0" />
        ))}
      </div>
