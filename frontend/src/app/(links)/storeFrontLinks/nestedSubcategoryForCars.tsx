...
export const BusSubLinks: CarSubCategory[] = carsNestedData.BusSubLinks;
...
export const carsNestedCategoriesMap: { [key: string]: CarSubCategory[] } = {
  "Cars for Sale": carsNestedData.CarsForSaleNestedSub,
  "Lease Cars": carsNestedData.LeaseCarsNestedSub,
  Buses: carsNestedData.BusSubLinks,
  Trailers: carsNestedData.TrailerNestedSub,
  "Car Parts": carsNestedData.CarPartsNestedSub,
  Truck: carsNestedData.TruckNestedSub,
  "Electric Cars": carsNestedData.ElectricCarsNestedSub,
};
