...
export const managerTotalLinks = [
  ...
  },
  {
    name: "Documents",
    icon: FaFileAlt,
    href: "/managers/documents",
    category: "core",
  },
  {
    name: "Resources",
    icon: FaFolder,
    href: "/managers/resources",
    category: "core",
  },
  {
    name: "Approvals",
  ...
  { name: "Car", icon: FaCar, href: "/managers/car", category: "inventory" },
  {
    name: "Real Estate",
    icon: FaHome,
    href: "/managers/real-estate",
    category: "inventory",
  },
  {
    name: "Motorcycles",
    icon: FaMotorcycle,
    href: "/managers/motorcycles",
    category: "inventory",
  },
  {
    name: "Tractor",
    icon: FaTractor,
    href: "/managers/tractor",
    category: "inventory",
  },
  {
    name: "Jobs",
  ...
  },
  {
    name: "Trucks",
    icon: FaTruck,
    href: "/managers/trucks",
    category: "inventory",
  },
  {
    name: "Phones",
    icon: FaMobileAlt,
    href: "/managers/phones",
    category: "inventory",
  },
  {
    name: "Electronics",
    icon: FaLaptop,
    href: "/managers/electronics",
    category: "inventory",
  },
  {
    name: "Bicycles",
    icon: FaBicycle,
    href: "/managers/bicycles",
    category: "inventory",
  },
  {
    name: "Equipment",
    icon: FaTools,
    href: "/managers/equipment",
    category: "inventory",
  },
