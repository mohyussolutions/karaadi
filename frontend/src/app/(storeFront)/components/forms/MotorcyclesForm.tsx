...
export default function MotorcyclesForm({
  ...
  const getFee = useCallback(
    (cat: string) =>
      activeFeeConfig ? Number(activeFeeConfig[MOTO_FEE_MAPPING[cat]] || 0) : 0,
    [activeFeeConfig],
  );
  const getNestedSubcategories = () =>
    formData.category
      ? (nesCategories.motorcyclesNestedMap as any)[formData.category] || []
      : [];
  ...
  const catOptions = MOTO_CATEGORY_KEYS.map((k) => ({
    value: k,
    label: t(`createMotorcycle.categories.${k}`),
  }));
  ...
  const fuelOptions = FUEL_TYPE_KEYS.map((k) => ({
    value: k,
    label: t(`createMotorcycle.fuelTypes.${k}`),
  }));
  const gearboxOptions = GEARBOX_KEYS.map((k) => ({
    value: k,
    label: t(`createMotorcycle.gearboxOptions.${k}`),
  }));
  const conditionOptions = CONDITION_KEYS.map((k) => ({
    value: k,
    label: t(`createMotorcycle.conditions.${k}`),
  }));
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <SelectField
              ...
              options={catOptions}
              placeholder={t("createMotorcycle.selectCategory")}
            />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-black text-gray-400 uppercase tracking-wider ml-1">
            ...
            <SelectField
              ...
              placeholder={t("createMotorcycle.selectSubcategory")}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {(
            [
              [
                ...
                t("createMotorcycle.yearPlaceholder"),
                true,
              ],
              [
                "make",
                t("createMotorcycle.makeLabel"),
                t("createMotorcycle.makePlaceholder"),
                true,
              ],
              [
                "model",
                t("createMotorcycle.modelLabel"),
                t("createMotorcycle.modelPlaceholder"),
                true,
              ],
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, engineCc: e.target.value })
              }
              className="w-full border-2 border-gray-100 p-3 rounded-xl font-bold outline-none focus:border-blue-500"
            />
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="space-y-1">
            ...
            <SelectField
              ...
              options={fuelOptions}
              placeholder={t("createMotorcycle.selectFuelType")}
              className="text-xs"
            />
          </div>
          <div className="space-y-1">
            ...
            <SelectField
              ...
              placeholder={t("createMotorcycle.selectGearbox")}
              className="text-xs"
            />
          </div>
          <div className="space-y-1">
            ...
            <SelectField
              ...
              placeholder={t("createMotorcycle.selectCondition")}
              className="text-xs"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <SelectField
              ...
              placeholder={t("createMotorcycle.selectRegion")}
            />
          </div>
        </div>
