...
export default function FarmEquipmentForm({
  ...
  const getFee = useCallback(
    (cat: string) =>
      activeFeeConfig
        ? Number(activeFeeConfig[EQUIPMENT_FEE_MAPPING[cat]] || 0)
        : 0,
    [activeFeeConfig],
  );
  const getNestedSubcategories = () =>
    formData.category
      ? (nesCategories.traktorNestedMap as any)[formData.category] || []
      : [];
  ...
  const catOptions = EQUIPMENT_CATEGORY_KEYS.map((k) => ({
    value: k,
    label: t(`createFarmequipment.categories.${k}`),
  }));
  ...
  const conditionOptions = CONDITION_KEYS.map((k) => ({
    value: k,
    label: t(`createFarmequipment.conditions.${k}`),
  }));
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <SelectField
              ...
              options={catOptions}
              placeholder={t("createFarmequipment.selectCategory")}
            />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-black text-gray-400 uppercase tracking-wider ml-1">
            ...
            <SelectField
              ...
              placeholder={t("createFarmequipment.selectSubcategory")}
          ...
          {(
            [
              ...
              [
                ...
                t("createFarmequipment.equipmentTypePlaceholder"),
              ],
              [
                "brand",
                t("createFarmequipment.brandLabel"),
                t("createFarmequipment.brandPlaceholder"),
              ],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <SelectField
              ...
              placeholder={t("createFarmequipment.selectCondition")}
              className="text-xs"
            />
          </div>
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  attachmentsIncluded: e.target.value,
                })
              }
              maxLength={100}
              className="w-full border-2 border-gray-100 p-3 rounded-xl font-bold outline-none focus:border-blue-500"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <SelectField
              ...
              placeholder={t("createFarmequipment.selectRegion")}
            />
          </div>
        </div>
