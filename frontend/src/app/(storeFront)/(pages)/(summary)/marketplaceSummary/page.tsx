...
import { useGetMarketplaceItemByIdQuery } from "@/app/(storeFront)/store/slices/marketplaceSlice";
...
const RealEstateSummary: React.FC = () => {
  ...
  const { data: item, isLoading } = useGetMarketplaceItemByIdQuery(
    itemId || "",
    {
      skip: !itemId,
    }
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8 mt-10 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {[
          ...
          { label: "Sub District", value: item.subDistrict || "N/A" },
