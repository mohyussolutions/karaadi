...
const BoatSummary: React.FC = () => {
  ...
  const { data: boat, isLoading } = useGetBoatByIdQuery(boatId || "", {
    skip: !boatId,
  });
  ...
  if (!boat) {
    return <p className="text-center mt-10 text-red-500">Boat not found.</p>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8 mt-10 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {[
          { label: "Title", value: boat.title },
          { label: "Category", value: boat.category },
          { label: "Subcategory", value: boat.subCategory },
          { label: "Type", value: boat.type },
          { label: "Model", value: boat.boatModel },
          { label: "Transmission", value: boat.transmission },
          { label: "Color", value: boat.color },
          { label: "Region", value: boat.region },
          { label: "City", value: boat.city },
          { label: "District", value: boat.district },
      ...
      <div className="mb-10">
        ...
        {boat.images && boat.images.length > 0 ? (
          <div className="flex flex-wrap gap-4">
            {boat.images.map((img: string, idx: number) => (
              <div
                key={idx}
