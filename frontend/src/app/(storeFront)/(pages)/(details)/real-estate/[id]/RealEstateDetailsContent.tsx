...
import type { RealEstate } from "@/app/utils/types/realestate.types";
...
interface Props {
  initialData?: RealEstate | null;
}

export default function RealEstateDetailsContent({ initialData }: Props) {
  ...
  return (
    <div className="my-12 px-4 md:px-6 min-h-screen pb-24 md:pb-0">
              ...
              {category && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-gray-800 capitalize">{category}</span>
                  </div>
                </div>
              )}
              ...
              {subcategory && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-gray-800 capitalize">{subcategory}</span>
                  </div>
                </div>
              )}
              ...
              {realEstate.bedrooms !== undefined && realEstate.bedrooms !== null && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-gray-800">{realEstate.bedrooms}</span>
                  </div>
                </div>
              )}
              ...
              {realEstate.bathrooms !== undefined && realEstate.bathrooms !== null && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-gray-800">{realEstate.bathrooms}</span>
                  </div>
                </div>
              )}
              ...
              {realEstate.floor !== undefined && realEstate.floor !== null && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-gray-800">
                      {realEstate.floor}
                      {realEstate.totalFloors ? ` / ${realEstate.totalFloors}` : ""}
                    </span>
                  </div>
                </div>
              )}
              ...
              {!realEstate.floor && realEstate.totalFloors !== undefined && realEstate.totalFloors !== null && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-gray-800">{realEstate.totalFloors}</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-2">
                {amenities.map((a: any) => (
                  ...
                  >
                    <span className="text-blue-500">{AMENITY_ICONS[a] ?? "✓"}</span>
                    {a}
                  </span>
                ))}
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="text-gray-700 leading-relaxed text-sm">
              ...
              {realEstate.description?.length > 300 && (
                ...
                >
                  {isExpanded ? t("realEstateDetail.showLess") : t("realEstateDetail.readMore")}
                </button>
              )}
            </div>
          </div>
      ...
      <Recommendations
        ...
        category={realEstate?.mainCategory ?? realEstate?.category?.[0] ?? undefined}
        limit={4}
      />
    </div>
  );
