...
export default function OtherItems({ initialData = [] }: { initialData?: any[] }) {
  ...
  const finalItems = useMemo(() => {
    let list = query.trim() ? searchResults : otherBaseItems;
    ...
    <div className="container mx-auto px-2 py-2 space-y-3">
      ...
      <ContainerLinks>
        <CommonSubCategoryLinks
          items={nesCategories.OtherNestedSub || []}
            ...
            <div className="text-xs font-medium text-gray-500 px-3 py-1 flex justify-between items-center">
              ...
              {!isLoading && (
                <span className="text-blue-700 font-bold">
                  {finalItems.length} {t("items", { defaultValue: "shay" })}
                </span>
              )}
            </div>
          </ContainerLinks>
