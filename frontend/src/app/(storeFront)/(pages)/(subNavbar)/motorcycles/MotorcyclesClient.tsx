...
import { motorcycleSubCategories } from "@/app/(links)/storeFrontLinks/mainCategotyCategorySubCategory";
...
function MotorcyclesLinks() {
  ...
  const { items, isLoading, isError } = useListingData<Motorcycle>("motorcycles", getMotorcycles);
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto px-2 py-2 space-y-4 overflow-x-hidden">
      ...
      <ContainerLinks>
        <SubCategoryList data={motorcycleSubCategories} cols={2} />
      </ContainerLinks>
