...
// Import icons needed for the subcategory links
import { GiBrickWall } from "react-icons/gi";
import { FaStore, FaTruckMoving } from "react-icons/fa";
...
function LandForSale() {
  ...
  const allLandItems = useMemo(() => {
    // Hubi in xogtaada backend-ka ay category-ga u isticmaalayso "Land"
  ...
  return (
    <div className="pb-10">
      ...
      {/* End Subcategory Navigation Bar */}
