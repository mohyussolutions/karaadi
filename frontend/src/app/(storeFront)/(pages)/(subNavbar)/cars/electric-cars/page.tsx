...
export default function ElectricCars() {
  ...
  const currentDisplayTitle = useMemo(() => {
    ...
    if (!selectedSubcategory) return "Gawaarida Korontada (Electric Cars)";
  ...
  return (
    <div className="container mx-auto px-4 pb-10">
      ...
      <div className="px-4 text-sm text-gray-700 mb-6 italic">
        ...
        gaari: <strong>{currentDisplayTitle}</strong>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {isLoading ? (
                ...
                <div className="col-span-full text-center py-20 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 text-gray-500">
                  Lama helin gawaari koronto oo ku haboon xogta aad raadineyso.
                </div>
              )}
            </div>
          )}
