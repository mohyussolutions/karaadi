...
function Grainharvester() {
  ...
  // 1. Shaandheyn Aasaasi ah: Soo qaado kaliya shayada ku jira "Grain Harvester"
  ...
  }, [allGrainHarvesterItems, selectedCategory]);
  ...
  const currentDisplayTitle = useMemo(() => {
    if (!selectedCategory) {
      return "All Grain Harvesters (Dhammaan Makiinada Goosashada Badarka)";
    }
  ...
  if (isError)
    return (
      <div className="text-center py-10 text-red-500">
        Failed to load Grain Harvesters
      </div>
    );
