...
// Removed FaUtensils, FaStar, etc., as they are now defined in antiques-data.ts
...
// Adjust path above based on where you save antiques-data.ts
...
function AntiquesAndArt() {
  ...
  // Use the statically defined list for the Nav Bar
  ...
  const currentItemDisplay =
    selectedSubcategory || "Dhamaan Alaabta Qadiimiga & Farshaxanka";
