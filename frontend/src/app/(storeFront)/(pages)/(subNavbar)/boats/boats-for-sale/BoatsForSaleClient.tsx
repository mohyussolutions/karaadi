...
export default function BoatsForSale({ initialData = [] }: { initialData?: any[] }) {
  ...
  const filteredList = useMemo(() => {
    let list: any[] = query.trim() ? [...searchResults] : [...allBoatsForSale];
    ...
    <div className="container mx-auto px-2 py-2 space-y-3">
      ...
      <ContainerLinks>
        <CommonSubCategoryLinks
          items={[...nesCategories.BoatsForSaleNestedSub]}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-3">
                {itemsToDisplay.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-20 text-gray-400 text-xs font-medium">
                    {t("noItemsFound", {
                      defaultValue: "Lama helin doonyo waafaqsan raadintaada.",
                    })}
                  </div>
                )}
              </div>
