...
export default function BoatEngines({ initialData = [] }: { initialData?: any[] }) {
  ...
  const filteredList = useMemo(() => {
    let list: any[] = query.trim() ? [...searchResults] : [...allEngineItems];
    ...
    <div className="container mx-auto px-2 py-2 space-y-3">
      ...
      <ContainerLinks>
        <CommonSubCategoryLinks
          items={[...(nesCategories.BoatEnginesNestedSub || [])]}
            ...
            <div className="text-xs font-medium text-gray-500 px-3 py-1 flex justify-between items-center">
              ...
              {!isLoading && (
                <span className="text-blue-700 font-bold">
                  ...
                  {t("boatEngines", { defaultValue: "matoorada doonyaha" })}
                </span>
              )}
            </div>
          </ContainerLinks>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-1.5 sm:gap-3">
                {itemsToDisplay.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-20 text-gray-400 text-xs font-medium">
                    {t("noBoatEnginesFound", {
                      defaultValue:
                        "Lama helin matoorada doonyaha oo waafaqsan raadintaada.",
                    })}
                  </div>
                )}
              </div>
