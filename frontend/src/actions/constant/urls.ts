const BASE_API_URL =
  process.env.NEXT_PUBLIC_API_URL || "https://karaadi.onrender.com";
...
export const CATEGORY_ENDPOINTS = {
  ...
  MOTORCYCLES_ADMIN: createEndpoint(`${API_PATHS.MOTORCYCLES}/all-including-unpaid`),
  REAL_ESTATE_ADMIN: createEndpoint(`${API_PATHS.REAL_ESTATE}/all-including-unpaid`),
  TRAKTOR_ADMIN: createEndpoint(`${API_PATHS.TRAKTOR}/all-including-unpaid`),
  MARKETPLACE_ADMIN: createEndpoint(`${API_PATHS.MARKETPLACE}/all-including-unpaid`),
...
export const FAVORITE_ENDPOINTS = {
  ...
  ITEM_SAVED_COUNT: (itemId: string) =>
    createEndpoint(`${API_PATHS.FAVORITES}/item/${itemId}/count`),
...
export const SEARCH_HISTORY_ENDPOINTS = {
  ...
  DELETE_BY_QUERY: createEndpoint(`${API_PATHS.HISTORY_SEARCH}/delete-by-query`),
