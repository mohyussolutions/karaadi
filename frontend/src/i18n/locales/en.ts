...
export const footer = {
  ...
  rights_short:
    "Please respect copyright. Do not redistribute without permission from {{brand}}.",
...
export const adminTable = {
  ...
  advertisementSubtitle:
    "Create and manage two types of ads: Sidebar (small card) and Background (full-width banner)",
  ...
  businessPlansSubtitle:
    "Manage plans — changes apply immediately to new business activity.",
  addPlan: "Add Plan",
  planName: "Plan Name",
